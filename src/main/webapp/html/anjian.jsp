...
<body>
	<form action="" method="post">
		<div id="box">
			<h3 style="margin-top: 20px;">◆◆◆基本情報◆◆◆</h3>
			<!-- 0. 報告区分・リスクの有無 -->
			<p style="float: left;">0.&nbsp;&nbsp;報告区分・リスクの有無</p>
				...
				<table cellpadding="0" cellspacing="0" border="1" id="reportTbl">
					<tr>
						<td class="l">報告区分</td>
						<td class="r">
							<span class="report"><input type="radio" >開催通知 兼 レビュー依頼書</span>
							<span class="report"><input type="radio" >議事録</span>
							<span class="report"><input type="radio" >リスクなしと判k断</span>
						</td>
					</tr>
					<tr>
						<td class="l">確認日</td>
				...
				<table cellpadding="0" cellspacing="0" border="1" id="reportTbl">
					...
					<tr>
						...
						<td class="r" colspan="3">
							<span class="process"><input type="radio" >営業プロセス（原価）</span>
							<span class="process"><input type="radio" >営業プロセス（見積）</span>
							<span class="process"><input type="radio" >購買プロセス</span>
							<span class="process"><input type="radio" >設計・開発プロセス</span>
						</td>
					</tr>
					<tr>
						<td class="l">検討段階*</td>
						<td class="r box" colspan="3">
							<span class="process"><input type="radio" >引合時</span>
							<span class="process"><input type="radio" >受注時</span>
							<span class="process"><input type="radio" >基本設計完了時</span>
							<span class="process"><input type="radio" >詳細設計完了時</span>
						</td>
					</tr>
				</table>
			<!-- 2. リスク予防管理検討会 実施内容 -->
